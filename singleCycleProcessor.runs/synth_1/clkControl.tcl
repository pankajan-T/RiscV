...
read_verilog -library xil_defaultlib H:/vivado/demo/singleCycleProcessor/singleCycleProcessor.srcs/sources_1/new/clkControl.v
...
synth_design -top clkControl -part xczu7ev-ffvc1156-2-e


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef clkControl.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file clkControl_utilization_synth.rpt -pb clkControl_utilization_synth.pb"
